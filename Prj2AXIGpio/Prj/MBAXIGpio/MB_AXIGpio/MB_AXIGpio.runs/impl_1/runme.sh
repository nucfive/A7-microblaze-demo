...
HD_PWD='C:/Prj/xilinxPrj/MicroblazePrj/Prj2AXIGpio/Prj/MBAXIGpio/MB_AXIGpio/MB_AXIGpio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_sys_gpio_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mb_sys_gpio_wrapper.tcl -notrace
