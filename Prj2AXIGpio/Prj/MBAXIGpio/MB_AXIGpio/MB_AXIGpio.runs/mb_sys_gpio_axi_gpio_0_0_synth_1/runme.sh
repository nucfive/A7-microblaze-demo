...
HD_PWD='C:/Prj/xilinxPrj/MicroblazePrj/Prj2AXIGpio/Prj/MBAXIGpio/MB_AXIGpio/MB_AXIGpio.runs/mb_sys_gpio_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_sys_gpio_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_sys_gpio_axi_gpio_0_0.tcl
