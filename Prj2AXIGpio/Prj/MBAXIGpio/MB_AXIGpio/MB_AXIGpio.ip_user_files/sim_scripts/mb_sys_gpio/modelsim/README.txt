...
#
# Generated by export_simulation on Fri Aug 10 09:29:08 +0800 2018
#
################################################################################
...
switch to the './mb_sys_gpio.sh' script.

./mb_sys_gpio.sh -reset_run
...
./mb_sys_gpio.sh -noclean_files

For more information on the script, please type './mb_sys_gpio.sh -help'.
