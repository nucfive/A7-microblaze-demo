...
xv_path="C:/ToolSoftWare/Xilinx/Vivado/2016.4"
...
{
  file="xsim.ini"
  lib_map_path="C:/ToolSoftWare/Xilinx/Vivado/2016.4/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Mb_GpioRead.wdb xsim.dir)
