...
#
# Generated by export_simulation on Fri Aug 10 12:14:50 +0800 2018
#
################################################################################
...
switch to the './Mb_GpioRead.sh' script.

./Mb_GpioRead.sh -reset_run
...
./Mb_GpioRead.sh -noclean_files

For more information on the script, please type './Mb_GpioRead.sh -help'.
