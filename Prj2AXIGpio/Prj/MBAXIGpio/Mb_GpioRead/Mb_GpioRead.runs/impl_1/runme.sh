...
HD_PWD='C:/Prj/xilinxPrj/MicroblazePrj/Prj2AXIGpio/Prj/MBAXIGpio/Mb_GpioRead/Mb_GpioRead.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mb_GpioRead_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mb_GpioRead_wrapper.tcl -notrace
