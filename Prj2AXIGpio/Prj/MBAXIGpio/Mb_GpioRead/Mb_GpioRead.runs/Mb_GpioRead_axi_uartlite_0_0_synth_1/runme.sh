...
HD_PWD='C:/Prj/xilinxPrj/MicroblazePrj/Prj2AXIGpio/Prj/MBAXIGpio/Mb_GpioRead/Mb_GpioRead.runs/Mb_GpioRead_axi_uartlite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mb_GpioRead_axi_uartlite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mb_GpioRead_axi_uartlite_0_0.tcl
