...
HD_PWD='C:/Prj/xilinxPrj/MicroblazePrj/Prj3Ddr2/Prj/mc_ddr2/mc_ddr2.runs/mb_ddr_auto_cc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_ddr_auto_cc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_ddr_auto_cc_0.tcl
