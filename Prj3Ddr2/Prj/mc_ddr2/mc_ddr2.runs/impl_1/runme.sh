...
HD_PWD='C:/Prj/xilinxPrj/MicroblazePrj/Prj3Ddr2/Prj/mc_ddr2/mc_ddr2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_ddr_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mb_ddr_wrapper.tcl -notrace
