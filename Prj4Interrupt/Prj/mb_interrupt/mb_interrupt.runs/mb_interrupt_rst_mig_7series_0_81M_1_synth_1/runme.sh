...
HD_PWD='C:/Prj/xilinxPrj/MicroblazePrj/Prj4Interrupt/Prj/mb_interrupt/mb_interrupt.runs/mb_interrupt_rst_mig_7series_0_81M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_interrupt_rst_mig_7series_0_81M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_interrupt_rst_mig_7series_0_81M_1.tcl
