...
HD_PWD='C:/Prj/xilinxPrj/MicroblazePrj/Prj4Interrupt/Prj/mb_interrupt/mb_interrupt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_interrupt_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mb_interrupt_wrapper.tcl -notrace
