...
HD_PWD='C:/Prj/xilinxPrj/MicroblazePrj/Prj4Interrupt/Prj/mb_interrupt/mb_interrupt.runs/mb_interrupt_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_interrupt_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_interrupt_axi_gpio_1_0.tcl
