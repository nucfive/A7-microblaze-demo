...
HD_PWD='C:/Prj/xilinxPrj/MicroblazePrj/Prj4Interrupt/Prj/mb_interrupt/mb_interrupt.runs/mb_interrupt_microblaze_0_axi_intc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_interrupt_microblaze_0_axi_intc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_interrupt_microblaze_0_axi_intc_1.tcl
