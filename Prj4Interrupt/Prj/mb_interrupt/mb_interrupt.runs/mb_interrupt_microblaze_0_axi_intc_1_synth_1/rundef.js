...
ISEStep( "vivado",
         "-log mb_interrupt_microblaze_0_axi_intc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_interrupt_microblaze_0_axi_intc_1.tcl" );
